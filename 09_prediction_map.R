...
path_model   <- "H:/Daten/Studium/2_Master/4_Semester/4_Daten/models_2cm/tls_rgb_geo/bla.hd5"  # input
...
use_these <- c("ortho", "anisotropy_max", "curvature_max", "linearity_max",
...
types <- c()
for (i in 1:length(raster_paths)) {types[i] <- strsplit(basename(raster_paths[i]), "_area_")[[1]][1]}
