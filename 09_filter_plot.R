...
# set paths
path_points_01 <- "H:/Daten/Studium/2_Master/4_Semester/4_Daten/data for plot/01_norm"  # input
path_points_02 <- "H:/Daten/Studium/2_Master/4_Semester/4_Daten/data for plot/02_no_stems"  # output
path_points_03 <- "H:/Daten/Studium/2_Master/4_Semester/4_Daten/data for plot/03_2m"  # output
path_points_04 <- "H:/Daten/Studium/2_Master/4_Semester/4_Daten/data for plot/04_filtered"  # output
